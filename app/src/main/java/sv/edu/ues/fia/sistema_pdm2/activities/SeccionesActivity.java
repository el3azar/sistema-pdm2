...
public class SeccionesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tvTitulo)).setText("Secciones");
        editIdBodega = findViewById(R.id.editIdBodega);
        listView     = findViewById(R.id.listView);
    }

    public void consultar(View v) {
        String idBodega = editIdBodega.getText().toString().trim();
        int servidor    = (v.getId() == R.id.btnLocal) ? 0 : 1;
        String parametro = idBodega.isEmpty() ? null : "id_bodega=" + idBodega;
        String url      = Urls.build(servidor, Urls.SECCIONES_LISTA, parametro);
            ...
            for (JSONObject o : datos) {
                try {
                    filas.add("Bodega: " + o.getString("NOMBRE_BODEGA") + "\n" +
                              ...
                              " | Capacidad: " + o.getString("CAPACIDAD_ACTUAL") +
